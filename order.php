...
if (isset($_POST['submit']))
{
    ...
    if ($_POST['submit'] == 'konfirmasi')
    {
        ...
        else
        {
            ...
            header("Location: status.php?id=" . $pdo->lastInsertId());
            exit();
        }
        unset($_SESSION['code']);
    }
}
$head = '<link href="assets/css/timeline.css" rel="stylesheet"/>';
      ...
      <div class="form-group">
        ...
        <div class="input-group">
          <span class="input-group-addon" style="padding: 0;">
            <img src="captcha.php" style="" alt="Loading...."/>
          </span>
