...
<div style="margin-top: 15px;" class="hidden-xs">
  <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item">
        <img data-src="holder.js/1140x230/auto/#777:#555/text:First slide" alt="Voucher Game" src="assets/game-1140x230.jpg" data-holder-rendered="true"/>
      ...
      <div class="item active">
        <img data-src="holder.js/1140x230/auto/#666:#444/text:Second slide" alt="Game" src="assets/pulsa-1140x230.jpg" data-holder-rendered="true"/>
        <div class="carousel-caption">
          <h3>
            Voucher Pulsa / BOLT
          </h3>
      ...
      <div class="item">
        <img data-src="holder.js/1140x230/auto/#555:#333/text:Third slide" alt="Third slide [1140x230]" src="assets/pln-1140x230.jpg" data-holder-rendered="true"/>
        <div class="carousel-caption">
          <h3>
...
<div class="row" style="margin-top: 15px;">
  <div class="col-sm-8">
    ...
    <div class="row">
        <div class="col-sm-4">
            <img class="img-responsive" title="MamaPulsa" alt="MamaPulsa" src="assets/img1.png"/>
        </div>
        <div class="col-sm-8">
            ...
            <div class="text-center">
                <a class="btn btn-warning btn-lg btn-block" href="order.php">Beli / Order</a>
            </div>
        </div>
    </div>
    </div>
  ...
  <div class="col-sm-4">
    <?php if ($berita):?>
      <div class="list-group">
        ...
        <a class="list-group-item" href="berita.php/<?php echo date('Y/m/d',$b->tanggal);?>/<?php echo str_link($b->judul); ?>?id=<?php echo $b->id; ?>" title="<?php echo __e($b->judul)?>">
